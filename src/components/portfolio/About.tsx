  ...
  return (
    <section id="about" className="section-rule py-28 md:py-40">
      <div className="mx-auto max-w-[1400px] px-8 md:px-12">
        ...
        {/* Header row */}
        <div className="reveal mb-16 grid gap-10 md:grid-cols-[1fr_1.4fr] md:items-end md:mb-20">
          <div>
        ...
        <div className="reveal grid gap-12 md:grid-cols-[1.4fr_1fr] md:gap-24" data-delay="1">
