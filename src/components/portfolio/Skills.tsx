  ...
  return (
    <section id="skills" className="section-rule py-28 md:py-40">
      <div className="mx-auto max-w-[1400px] px-8 md:px-12">
        ...
        <div className="reveal mb-16 grid gap-8 md:grid-cols-[1fr_1.2fr] md:items-end md:mb-20">
          <div>
        ...
        <div className="reveal grid grid-cols-2 gap-px overflow-hidden rounded-2xl border border-border bg-border lg:grid-cols-4" data-delay="1">
          {groups.map((g) => (
            <div
              key={g.n}
